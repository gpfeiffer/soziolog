...
class SubscriptionsControllerTest < ActionController::TestCase
  ...
  test "should create subscription" do
    assert_difference('Subscription.count') do
      post :create, subscription: { member_id: @subscription.member_id, paid_on: @subscription.paid_on, payment: @subscription.payment, transaction_id: @subscription.transaction_id, value: @subscription.value, year: @subscription.year }
    end
