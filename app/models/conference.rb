...
class Conference < ActiveRecord::Base
  attr_accessible :applicant, :call, :conference_url, :date, :description, :document_url, :email, :funding, :host, :length, :name, :received_on, :request
...
Please let me have your university bank/contact details 
as soon as possible so that the funds can be transferred 
without delay.
